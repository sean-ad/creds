		...
		<div class="panel panel-warning">
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-6 text-right">
						<p class="announcement-heading"><?php echo $projects_count?></p>
			...
			<a href="#">
				<div class="panel-footer announcement-bottom">
					<div class="row">
						<div class="col-xs-6">
							<!-- TODO: Change this to jquery like above-->
							<?php echo $this->Html->link(__('View Projects'), array('controller' => 'projects', 'action' => 'index')); ?>
						</div>
						<div class="col-xs-6 text-right">
							<i class="fa fa-arrow-circle-right"></i>
						</div>
